            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if (child.getKey().equals("imagens")) {
                        DatabaseReference refImagem = child.getRef();
                        for (DataSnapshot childImage : child.getChildren()) {
                            Uri imageUri = Uri.parse(childImage.getValue().toString());
                            try {
                    ...
                    Gato gatoNovo = new Gato(nomeGato,null,caractGato,latLngGato,teleGato);
